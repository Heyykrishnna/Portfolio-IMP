      ...
      <div key={node.id} className="select-none">
        <motion.div
          className={cn(
            ...
            "hover:bg-white/5",
            isSelected ? "bg-white/10 text-gold" : "text-cream",
            selectable && "hover:border-white/10",
          )}
        ...
        >
          ...
          <motion.div
            className="flex items-center justify-center w-4 h-4 mr-1 text-cream-dim"
          ...
          {showIcons && (
            <motion.div
              className="flex items-center justify-center w-4 h-4 mr-2 text-cream"
          ...
          <span className="text-sm font-body tracking-wide truncate flex-1 leading-none pt-[1px]">
            {node.label}
          </span>
        </motion.div>
